...
export const HUD: React.FC<HUDProps> = ({ 
  ...
  return (
    <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-8 gap-4 w-full shrink-0">
      <div className="flex flex-row items-center gap-2 md:gap-4 w-full md:w-auto overflow-x-auto pb-2 md:pb-0">
        <div className={`border-2 md:border-4 border-black bg-white p-2 md:p-3 -rotate-2 transform shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] shrink-0`}>
        ...
        <div className="border-2 md:border-4 border-black bg-white p-2 md:p-3 rotate-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2 md:gap-4 shrink-0">
          <div>
        ...
        {(mode === 'random' || mode === 'challenge') && (
          <div className={`border-2 md:border-4 border-black ${timeLeft <= 10 ? 'bg-[#ff0000] text-white animate-pulse' : 'bg-[#00ffff] text-black'} p-2 md:p-3 rotate-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] shrink-0`}>
      ...
      <button 
        onClick={onAbort}
        className="border-2 md:border-4 border-black bg-[#ffea00] px-3 py-2 md:px-4 md:py-2 text-sm md:text-lg font-black uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none transition-all transform rotate-2 shrink-0 ml-auto md:ml-0"
      >
        Abort
      </button>
    </header>
