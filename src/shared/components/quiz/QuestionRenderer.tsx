  ...
  return (
    <div className={`border-4 border-black p-4 md:p-8 w-full bg-white text-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden`}>
      <AnimatePresence mode="wait">
        ...
        >
          <div className="font-black text-4xl md:text-5xl lg:text-7xl mb-6 flex items-center justify-center gap-2 md:gap-4 w-full text-center flex-wrap">
              ...
              <>
                ...
                {currentQ.b && (
                  <>
                    ...
                    <span className={`border-b-8 border-black pb-1 px-2 md:px-4 text-yellow-500 drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]`}>{currentQ.b}</span>
                  </>
                )}
                <span className="text-4xl">=</span>
              </>
          ...
          <form onSubmit={onSubmit} className="w-full max-w-xs relative">
            <input
              ...
              className={`w-full text-center text-4xl md:text-5xl font-black p-2 md:p-4 border-[6px] border-black outline-none ${config.theme.primaryBg} ${config.theme.primaryText} shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] focus:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] focus:translate-y-[-2px] focus:translate-x-[-2px] transition-all uppercase`}
              placeholder="?"
              autoFocus
            />
          </form>
