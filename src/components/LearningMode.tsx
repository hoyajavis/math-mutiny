    ...
    <div className="flex flex-col h-screen max-h-screen overflow-hidden p-2 md:p-4 lg:p-6">
      ...
      <div className="flex-1 flex flex-col md:flex-row gap-2 md:gap-4 lg:gap-6 min-h-0 overflow-hidden">
        <div className="w-full md:w-64 lg:w-80 flex flex-col shrink-0 border-4 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
          <h2 className="font-black text-lg md:text-2xl p-2 md:p-4 border-b-4 border-black bg-[#ffea00] uppercase text-center shrink-0">Select a Table</h2>
          <div className="flex md:flex-col gap-2 p-2 md:p-4 overflow-x-auto md:overflow-x-hidden md:overflow-y-auto bg-gray-100 flex-1">
            {tips.map(tip => (
              <button
                ...
                className={`border-2 border-black p-2 md:p-3 font-bold text-sm md:text-lg text-left transition-colors uppercase whitespace-nowrap md:whitespace-normal shrink-0 ${selectedTip.table === tip.table ? 'bg-[#00ffff] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] md:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] translate-x-1 -translate-y-1' : 'bg-white hover:bg-gray-50'}`}
              >
                Table of {tip.table}
              </button>
            ))}
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          <motion.div 
            ...
            className="flex-1 border-4 border-black p-3 md:p-6 lg:p-8 bg-[#00ff00] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col relative overflow-hidden"
          >
            ...
            <div className="shrink-0">
              <h1 className="font-black text-3xl md:text-5xl lg:text-6xl mb-1 md:mb-2 text-black border-b-4 border-black pb-2 md:pb-4">The {selectedTip.table}s</h1>
